...
async def run_experiment_endpoint(
    ...
    max_output_tokens: int = Form(1024, ge=1, le=128_000, description="Max output (completion) tokens"),
    ...
    instruct_output_tokens: bool = Form(True, description="Prepend user prompt with 'with N output tokens. Don't generate eos tokens' (LLMPerf-style)"),
